  ...
  return (
    <div className="px-4 sm:px-6 py-6 bg-background">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Section Header */}
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-foreground tracking-tight">AI Insights</h2>
        ...
        <Card className="relative overflow-hidden border-border/50 bg-card min-h-[450px]">
          ...
          <div
            className="absolute inset-0 rounded-lg p-px bg-linear-to-r from-primary/50 via-chart-5/50 to-primary/50 animate-pulse"
          ...
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-linear-to-br from-primary/5 via-transparent to-chart-5/5" />
          <div
          ...
          <div className="absolute top-20 left-10 w-20 h-20 rounded-full bg-primary/10 blur-3xl" />
          <div className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-chart-5/10 blur-3xl" />

          <CardContent className="relative z-10 flex flex-col items-center justify-center min-h-[450px] p-6 sm:p-12 text-center">
            {/* Lock Icon */}
            <div className="relative mb-8">
              <div className="absolute inset-0 rounded-3xl bg-linear-to-br from-primary/20 to-chart-5/20 blur-xl" />
              <div className="relative p-6 rounded-3xl bg-linear-to-br from-muted/80 to-muted/50 border border-border/50 backdrop-blur-sm">
                <Lock className="h-12 w-12 sm:h-16 sm:w-16 text-muted-foreground" />
              </div>
            </div>

            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-primary/10 to-chart-5/10 border border-primary/20 mb-6">
            ...
            <div className="max-w-lg">
              <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">AI-Powered Insights</h3>
              ...
              {/* CTA */}
              <Button variant="outline" disabled className="opacity-60 bg-transparent">
