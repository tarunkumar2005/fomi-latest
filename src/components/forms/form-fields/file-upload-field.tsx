    ...
    <>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Maximum size per file in bytes. Common values: 1MB = 1,048,576 | 5MB
            = 5,242,880 | 10MB = 10,485,760
          </p>
        </div>
        ...
        <div className="p-4 bg-muted/50 rounded-lg border border-border/50">
          <div className="flex items-start gap-2">
            ...
            <div className="space-y-2 text-xs text-muted-foreground leading-relaxed">
              ...
              <p>
                <strong className="text-foreground">Size Limits:</strong> Helps
                prevent oversized uploads and ensures smooth form submissions
              </p>
              <p>
