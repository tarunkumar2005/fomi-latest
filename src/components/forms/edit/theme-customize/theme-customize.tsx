...
export default function ThemeCustomize({ theme, onThemeChange, isLoading }: ThemeCustomizeProps) {
  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-5 lg:p-6 space-y-7 pb-24">
        {/* Header */}
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              <ToggleGroupItem
                value="compact"
                className="flex-1 flex flex-col items-center gap-1 h-auto py-3 rounded-lg data-[state=on]:bg-card data-[state=on]:shadow-sm"
              >
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              <ToggleGroupItem
                value="solid"
                className="flex-1 h-9 text-xs rounded-lg data-[state=on]:bg-card data-[state=on]:shadow-sm"
              >
                Solid
              </ToggleGroupItem>
              <ToggleGroupItem
