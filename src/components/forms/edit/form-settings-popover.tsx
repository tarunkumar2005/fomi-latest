...
export default function FormSettingsPopover({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent
        align="end"
        className="w-[340px] p-0 shadow-xl border-border/50"
        sideOffset={8}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-muted/30">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-7 w-7 p-0 hover:bg-background rounded-full"
        ...
        <div className="p-4 space-y-4 max-h-[400px] overflow-y-auto">
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-2">
              <div className="h-6 w-6 rounded-md bg-chart-1/10 flex items-center justify-center">
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-2">
              <div className="h-6 w-6 rounded-md bg-chart-2/10 flex items-center justify-center">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-2">
              <div className="h-6 w-6 rounded-md bg-success/10 flex items-center justify-center mt-0.5">
        ...
        <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-border bg-muted/20">
          ...
          <Button
            ...
            onClick={handleSave}
            disabled={isSaving}
            className="h-8 px-4 text-xs min-w-20"
          >
            {isSaving ? (
